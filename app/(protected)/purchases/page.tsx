            ...
            <Card key={purchase.id} className="border border-white/[0.06] bg-white/[0.02] hover:bg-white/[0.04] transition-colors">
              <CardHeader className="space-y-4">
                <div className="aspect-video bg-white/[0.04] rounded-xl flex items-center justify-center overflow-hidden">
                  {purchase.listings?.images && purchase.listings.images.length > 0 ? (
                    <img src={purchase.listings.images[0]} alt={purchase.listings?.title} className="w-full h-full object-cover rounded-xl" />
                  ) : (
