...
import { Search, Sparkles, Bookmark, User, ChevronDown, PlusSquare, FolderPlus, Upload } from "lucide-react"
            ...
            <div className="flex items-center gap-3">
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button className="shadow-glow hidden sm:inline-flex">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-56">
                  ...
                  {/* Creator — all authenticated users can publish */}
                  <DropdownMenuSeparator />
                  <div className="px-2 py-1.5 text-sm font-semibold text-text-tertiary">
                    Creator
                  </div>
