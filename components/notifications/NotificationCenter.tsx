    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        {n.action_url && n.action_label && (
          <Link
            href={n.action_url}
            className="inline-flex items-center gap-1 mt-1.5 text-xs font-semibold text-amber-400 hover:text-amber-300 transition-colors"
...
export function NotificationBell() {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {/* Panel */}
      {open && (
        <div className="absolute right-0 top-12 w-[380px] rounded-2xl border border-white/[0.08] bg-[#0a0a12]/98 backdrop-blur-2xl shadow-2xl z-50 overflow-hidden animate-scale-in">
          {/* Header */}
