...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        default:
          "border-transparent bg-gradient-to-br from-cta to-cta-light text-primary",
        secondary:
          "border-transparent bg-surface text-text-secondary hover:bg-elevated",
        destructive:
          "border-transparent bg-accent-red text-white hover:bg-accent-red/80",
        outline: "border-border text-text-primary",
        gold: "border-transparent bg-gradient-to-br from-cta to-cta-light text-primary",
        success:
